...
- Timestamp: `2022-06-21 13:24`
- Build ID: `0cb04210-325a-4eb3-ac8b-d5d2d68edbc6`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0cb04210-325a-4eb3-ac8b-d5d2d68edbc6.git
$ cd 0cb04210-325a-4eb3-ac8b-d5d2d68edbc6
```
